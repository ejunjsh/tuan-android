...
public class BitmapManager {  
    ...
    public void loadBitmap(String url, ImageView imageView, Bitmap defaultBmp, int width, int height) {  
        ...
        if (bitmap != null) {  
        	...
        	//加载SD卡中的图片缓存
        	String filename = url.replaceAll(AppConfig.URL_SPLITTER,"_");
            ...
            public void handleMessage(Message msg) {  
                ...
                if (tag != null && tag.equals(url)) {  
                    if (msg.obj != null) {  
                        ...
                        try {
                        	//向SD卡中写入图片缓存
							ImageUtils.saveImage(imageView.getContext(), url.replaceAll(AppConfig.URL_SPLITTER,"_"), (Bitmap) msg.obj);
						} catch (IOException e) {
							e.printStackTrace();
						}
                    } 
